...
router.post('/expand-with-fill', requireAuth, validateBflExpandWithFill , makeCreditCost('bfl','expandWithFill', computeBflExpandWithFillCost), bflController.expandWithFill);
