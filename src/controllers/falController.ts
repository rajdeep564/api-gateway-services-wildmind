...
async function generate(req: Request, res: Response, next: NextFunction) {
  try {
    ...
    const debitOutcome = await postSuccessDebit(
      uid,
      result,
      ctx,
      "fal",
    ...
    const debitedCredits =
      debitOutcome === "WRITTEN" ? Number(ctx.creditCost) || 0 : 0;
    res.json(
      formatApiResponse("success", message, {
        ...result,
        debitedCredits,
...
export const falController = {
  ...
  async briaExpandImage(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      res.json(
        formatApiResponse("success", "Expanded", {
          ...result,
  ...
  async outpaintImage(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      res.json(
        formatApiResponse("success", "Outpainted", {
          ...result,
          debitedCredits: ctx.creditCost,
          debitStatus: debitOutcome,
        }),
  ...
  async topazUpscaleImage(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      res.json(
        formatApiResponse("success", "Upscaled", {
          ...result,
          debitedCredits: ctx.creditCost,
          debitStatus: debitOutcome,
        }),
  ...
  async seedvrUpscaleImage(req: Request, res: Response, next: NextFunction) {
    try {
      const uid = req.uid;
      const ctx = (req as any).context || {};
      const result = await (falService as any).seedvrUpscaleImage(
        uid,
        req.body || {},
      );
      const debitOutcome = await postSuccessDebit(
  ...
  async birefnetVideo(req: Request, res: Response, next: NextFunction) {
    try {
      const uid = req.uid;
      const ctx = (req as any).context || {};
      const result = await (falService as any).birefnetVideo(
        uid,
        req.body || {},
      );
      const debitOutcome = await postSuccessDebit(
      ...
      res.json(
        formatApiResponse("success", "Background removed", {
          ...result,
          debitedCredits: ctx.creditCost,
          debitStatus: debitOutcome,
        }),
  ...
  async image2svg(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      res.json(
        formatApiResponse("success", "Converted to SVG", {
          ...result,
          debitedCredits: ctx.creditCost,
          debitStatus: debitOutcome,
        }),
  ...
  async recraftVectorize(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      res.json(
        formatApiResponse("success", "Vectorized to SVG", {
          ...result,
          debitedCredits: ctx.creditCost,
          debitStatus: debitOutcome,
        }),
  ...
  async briaGenfill(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      res.json(
        formatApiResponse("success", "Generated", {
          ...result,
          debitedCredits: ctx.creditCost,
          debitStatus: debitOutcome,
        }),
  ...
  async veoTtvSubmit(req: Request, res: Response, next: NextFunction) {
    try {
      const uid = req.uid;
      const ctx = (req as any).context || {};
      const result = await falQueueService.veoTtvSubmit(
        uid,
        req.body || {},
        false,
      );
  ...
  async veo31TtvSubmit(req: Request, res: Response, next: NextFunction) {
    try {
      const uid = req.uid;
      const ctx = (req as any).context || {};
      const result = await falQueueService.veo31TtvSubmit(
        uid,
        req.body || {},
        false,
      );
  ...
  async veo31LiteTtvSubmit(req: Request, res: Response, next: NextFunction) {
    try {
      const uid = req.uid;
      const ctx = (req as any).context || {};
      const result = await falQueueService.veo31LiteTtvSubmit(
        uid,
        req.body || {},
      );
      res.json(
  ...
  async veoI2vSubmit(req: Request, res: Response, next: NextFunction) {
    try {
      const uid = req.uid;
      const ctx = (req as any).context || {};
      const result = await falQueueService.veoI2vSubmit(
        uid,
        req.body || {},
        false,
      );
  ...
  async veo31I2vSubmit(req: Request, res: Response, next: NextFunction) {
    try {
      const uid = req.uid;
      const ctx = (req as any).context || {};
      const result = await falQueueService.veo31I2vSubmit(
        uid,
        req.body || {},
        false,
      );
  ...
  async veo31LiteI2vSubmit(req: Request, res: Response, next: NextFunction) {
    try {
      const uid = req.uid;
      const ctx = (req as any).context || {};
      const result = await falQueueService.veo31LiteI2vSubmit(
        uid,
        req.body || {},
      );
      res.json(
  ...
  async veo31FirstLastFastSubmit(
    ...
    try {
      const uid = req.uid;
      const ctx = (req as any).context || {};
      const result = await falQueueService.veo31FirstLastFastSubmit(
        uid,
        req.body || {},
      );
      res.json(
  ...
  async veo31ReferenceToVideoSubmit(
    ...
    try {
      const uid = req.uid;
      const ctx = (req as any).context || {};
      const result = await falQueueService.veo31ReferenceToVideoSubmit(
        uid,
        req.body || {},
      );
      res.json(
  ...
  async veo31FirstLastSubmit(req: Request, res: Response, next: NextFunction) {
    try {
      const uid = req.uid;
      const ctx = (req as any).context || {};
      const result = await falQueueService.veo31FirstLastSubmit(
        uid,
        req.body || {},
      );
      res.json(
  ...
  async sora2ProI2vSubmit(req: Request, res: Response, next: NextFunction) {
    try {
      const uid = req.uid;
      const ctx = (req as any).context || {};
      const result = await falQueueService.sora2ProI2vSubmit(
        uid,
        req.body || {},
      );
      res.json(
  ...
  async pixverseV6T2vSubmit(req: Request, res: Response, next: NextFunction) {
    try {
      const uid = req.uid;
      const ctx = (req as any).context || {};
      const result = await falQueueService.pixverseV6T2vSubmit(
        uid,
        req.body || {},
      );
      res.json(
  ...
  async pixverseV6I2vSubmit(req: Request, res: Response, next: NextFunction) {
    try {
      const uid = req.uid;
      const ctx = (req as any).context || {};
      const result = await falQueueService.pixverseV6I2vSubmit(
        uid,
        req.body || {},
      );
      res.json(
  ...
  async sora2ProT2vSubmit(req: Request, res: Response, next: NextFunction) {
    try {
      const uid = req.uid;
      const ctx = (req as any).context || {};
      const result = await falQueueService.sora2ProT2vSubmit(
        uid,
        req.body || {},
      );
      res.json(
  ...
  async sora2RemixV2vSubmit(req: Request, res: Response, next: NextFunction) {
    try {
      const uid = req.uid;
      const ctx = (req as any).context || {};
      const result = await falQueueService.sora2RemixV2vSubmit(
        uid,
        req.body || {},
      );
      res.json(
  ...
  async klingO1FirstLastSubmit(
    ...
    try {
      const uid = req.uid;
      const ctx = (req as any).context || {};
      const result = await falQueueService.klingO1FirstLastSubmit(
        uid,
        req.body || {},
      );
      res.json(
  ...
  async klingO1ReferenceSubmit(
    ...
    try {
      const uid = req.uid;
      const ctx = (req as any).context || {};
      const result = await falQueueService.klingO1ReferenceSubmit(
        uid,
        req.body || {},
      );
      res.json(
  ...
  async kling26ProT2vSubmit(req: Request, res: Response, next: NextFunction) {
    try {
      const uid = req.uid;
      const ctx = (req as any).context || {};
      const result = await falQueueService.kling26ProT2vSubmit(
        uid,
        req.body || {},
      );
      res.json(
  ...
  async kling26ProI2vSubmit(req: Request, res: Response, next: NextFunction) {
    try {
      const uid = req.uid;
      const ctx = (req as any).context || {};
      const result = await falQueueService.kling26ProI2vSubmit(
        uid,
        req.body || {},
      );
      res.json(
  ...
  async klingV3StandardT2vSubmit(
    req: Request,
    res: Response,
    next: NextFunction,
  ) {
    try {
      const uid = req.uid;
      const ctx = (req as any).context || {};
      const result = await falQueueService.klingV3StandardT2vSubmit(
        uid,
        req.body || {},
      );
      res.json(
  ...
  async klingV3StandardI2vSubmit(
    req: Request,
    res: Response,
    next: NextFunction,
  ) {
    try {
      const uid = req.uid;
      const ctx = (req as any).context || {};
      const result = await falQueueService.klingV3StandardI2vSubmit(
        uid,
        req.body || {},
      );
      res.json(
  ...
  async klingV3ProT2vSubmit(req: Request, res: Response, next: NextFunction) {
    try {
      const uid = req.uid;
      const ctx = (req as any).context || {};
      const result = await falQueueService.klingV3ProT2vSubmit(
        uid,
        req.body || {},
      );
      res.json(
  ...
  async klingV3ProI2vSubmit(req: Request, res: Response, next: NextFunction) {
    try {
      const uid = req.uid;
      const ctx = (req as any).context || {};
      const result = await falQueueService.klingV3ProI2vSubmit(
        uid,
        req.body || {},
      );
      res.json(
  ...
  async ltx2ProI2vSubmit(req: Request, res: Response, next: NextFunction) {
    try {
      const uid = req.uid;
      const ctx = (req as any).context || {};
      const result = await falQueueService.ltx2ProI2vSubmit(
        uid,
        req.body || {},
      );
      res.json(
  ...
  async ltx2FastI2vSubmit(req: Request, res: Response, next: NextFunction) {
    try {
      const uid = req.uid;
      const ctx = (req as any).context || {};
      const result = await falQueueService.ltx2FastI2vSubmit(
        uid,
        req.body || {},
      );
      res.json(
  ...
  async ltx2ProT2vSubmit(req: Request, res: Response, next: NextFunction) {
    try {
      const uid = req.uid;
      const ctx = (req as any).context || {};
      const result = await falQueueService.ltx2ProT2vSubmit(
        uid,
        req.body || {},
      );
      res.json(
  ...
  async ltx2FastT2vSubmit(req: Request, res: Response, next: NextFunction) {
    try {
      const uid = req.uid;
      const ctx = (req as any).context || {};
      const result = await falQueueService.ltx2FastT2vSubmit(
        uid,
        req.body || {},
      );
      res.json(
  ...
  async uploadVoice(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      if (!audioData || typeof audioData !== "string") {
        return res
          ...
          .json(
            formatApiResponse(
              "error",
              "audioData is required and must be a data URI",
              null,
            ),
          );
      }
      ...
      if (!audioData.startsWith("data:audio/")) {
        return res
          .status(400)
          .json(formatApiResponse("error", "Invalid audio data URI", null));
      }
      ...
      if (
        ...
        return res
          .status(400)
          .json(formatApiResponse("error", "fileName is required", null));
      }

      const trimmedFileName = fileName.trim();

      // Check for duplicate file name
      const nameExists = await userAudioRepository.checkFileNameExists(
        uid,
        trimmedFileName,
      );
      ...
      if (nameExists) {
        return res
          ...
          .json(
            formatApiResponse(
              "error",
              `Name "${trimmedFileName}" is already taken. Please try a different name.`,
              null,
            ),
          );
      }
      ...
      res.json(
        formatApiResponse("success", "Voice file uploaded", {
          url: stored.publicUrl,
          storagePath: stored.key,
          fileName: trimmedFileName,
        }),
  ...
  async listUserAudioFiles(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      res.json(
        formatApiResponse("success", "Audio files retrieved", { audioFiles }),
      );
    } catch (err) {
      next(err);
    }
  ...
  async deleteUserAudioFile(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      const storageKey =
        audioDoc.storagePath || extractKeyFromUrl(audioDoc.url || "");
      if (storageKey) {
  ...
  async qwenMultipleAngles(req: Request, res: Response, next: NextFunction) {
    try {
      const uid = req.uid;
      const ctx = (req as any).context || {};
      const result = await (falService as any).qwenMultipleAngles(
        uid,
        req.body || {},
      );
      const debitOutcome = await postSuccessDebit(
        ...
        ctx,
        "fal",
        "qwen_multiple_angles",
      );
      res.json(
        formatApiResponse("success", "Camera angles generated", {
          ...result,
          debitedCredits: ctx.creditCost,
          debitStatus: debitOutcome,
        }),
