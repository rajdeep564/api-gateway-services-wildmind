...
const FAL_ERROR_TITLES: Record<string, string> = {
  ...
  geo_restricted: 'Region Restricted',
...
const FAL_ERROR_HINTS: Record<string, string> = {
  ...
  forbidden: 'This FAL model is not available for the current account, region, or access tier.',
  permission_denied: 'The request was blocked because this model is not enabled for the current account.',
  unauthorized: 'Authorization failed. Please check the API key and end-user requirements.',
  geo_restricted: 'This model is restricted in the current region or account context.',
