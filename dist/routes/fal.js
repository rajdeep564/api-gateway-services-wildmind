...
router.post("/outpaint", authMiddleware_1.requireAuth, validateFalGenerate_1.validateFalOutpaint, (0, creditCostFactory_1.makeCreditCost)("fal", "outpaint", (req) => (0, falPricing_1.computeFalOutpaintCost)(req)), falController_1.falController.outpaintImage);
// Bria Expand (image outpaint with resizing)
router.post("/bria/expand", authMiddleware_1.requireAuth, validateFalGenerate_1.validateFalBriaExpand, (0, creditCostFactory_1.makeCreditCost)("fal", "bria_expand", (req) => (0, falPricing_1.computeFalOutpaintCost)(req)), falController_1.falController.briaExpandImage);
...
router.post("/bria/genfill", authMiddleware_1.requireAuth, validateFalGenerate_1.validateFalBriaGenfill, (0, creditCostFactory_1.makeCreditCost)("fal", "bria_genfill", (req) => (0, falPricing_1.computeFalBriaGenfillCost)(req)), falController_1.falController.briaGenfill);
