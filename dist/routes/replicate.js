...
const seedancePricing_1 = require("../utils/pricing/seedancePricing");
const pixversePricing_1 = require("../utils/pricing/pixversePricing");
...
const validateSeedanceT2V_1 = require("../middlewares/validators/replicate/validateSeedanceT2V");
const validateSeedanceI2V_1 = require("../middlewares/validators/replicate/validateSeedanceI2V");
const validatePixverseT2V_1 = require("../middlewares/validators/replicate/validatePixverseT2V");
const validatePixverseI2V_1 = require("../middlewares/validators/replicate/validatePixverseI2V");
...
router.post('/seedance-t2v/submit', authMiddleware_1.requireAuth, validateSeedanceT2V_1.validateSeedanceT2V, (0, creditCostFactory_1.makeCreditCost)('replicate', 'seedance-t2v', seedancePricing_1.computeSeedanceVideoCost), replicateController_1.replicateController.seedanceT2vSubmit);
router.post('/seedance-i2v/submit', authMiddleware_1.requireAuth, validateSeedanceI2V_1.validateSeedanceI2V, (0, creditCostFactory_1.makeCreditCost)('replicate', 'seedance-i2v', seedancePricing_1.computeSeedanceVideoCost), replicateController_1.replicateController.seedanceI2vSubmit);
// ============ Queue-style endpoints for Replicate PixVerse v5 ============
router.post('/pixverse-v5-t2v/submit', authMiddleware_1.requireAuth, validatePixverseT2V_1.validatePixverseT2V, (0, creditCostFactory_1.makeCreditCost)('replicate', 'pixverse-t2v', pixversePricing_1.computePixverseVideoCost), replicateController_1.replicateController.pixverseT2vSubmit);
router.post('/pixverse-v5-i2v/submit', authMiddleware_1.requireAuth, validatePixverseI2V_1.validatePixverseI2V, (0, creditCostFactory_1.makeCreditCost)('replicate', 'pixverse-i2v', pixversePricing_1.computePixverseVideoCost), replicateController_1.replicateController.pixverseI2vSubmit);
