...
// Upscale
router.post('/upscale', authMiddleware_1.requireAuth, validateRemoveBg_1.validateUpscale, (0, creditCostFactory_1.makeCreditCost)('replicate', 'upscale', replicatePricing_1.computeReplicateUpscaleCost), async (req, res, next) => {
    try {
...
router.post('/generate', authMiddleware_1.requireAuth, validateRemoveBg_1.validateReplicateGenerate, (0, creditCostFactory_1.makeCreditCost)('replicate', 'generate', replicatePricing_1.computeReplicateImageGenCost), async (req, res, next) => {
    try {
