...
exports.validateBflExpandWithFill = exports.validateBflDepth = exports.validateBflCanny = exports.validateBflExpand = exports.validateBflFill = exports.validateBflGenerate = exports.ALLOWED_MODELS = void 0;
...
exports.validateBflExpandWithFill = [
    (0, express_validator_1.body)('image').isString().notEmpty().withMessage('image is required'),
    (0, express_validator_1.body)('canvas_size').isArray({ min: 2, max: 2 }).withMessage('canvas_size must be [width, height]'),
    (0, express_validator_1.body)('canvas_size.*').isInt({ min: 1, max: 5000 }).withMessage('canvas_size values must be 1-5000'),
    (0, express_validator_1.body)('original_image_size').isArray({ min: 2, max: 2 }).withMessage('original_image_size must be [width, height]'),
    (0, express_validator_1.body)('original_image_size.*').isInt({ min: 1, max: 5000 }).withMessage('original_image_size values must be 1-5000'),
    (0, express_validator_1.body)('original_image_location').optional().isArray({ min: 2, max: 2 }).withMessage('original_image_location must be [x, y]'),
    (0, express_validator_1.body)('original_image_location.*').optional().isInt(),
    (0, express_validator_1.body)('steps').optional().isInt({ min: 15, max: 50 }),
    (0, express_validator_1.body)('guidance').optional().isFloat({ min: 1.5, max: 100 }),
    (0, express_validator_1.body)('seed').optional().isInt(),
    (0, express_validator_1.body)('safety_tolerance').optional().isInt({ min: 0, max: 6 }),
    ...common,
];
