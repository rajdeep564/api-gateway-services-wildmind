...
exports.validateSeedanceI2V = void 0;
...
exports.validateSeedanceI2V = [
    ...
    (0, express_validator_1.body)('last_frame_image').optional().isString().isLength({ min: 5 }),
    ...
    (req, _res, next) => {
        ...
        if (Array.isArray(req.body.reference_images) && req.body.reference_images.length > 0) {
            ...
            if (req.body.last_frame_image && String(req.body.last_frame_image).length > 5) {
                return next(new errorHandler_1.ApiError('reference_images cannot be used with last_frame_image', 400));
            }
